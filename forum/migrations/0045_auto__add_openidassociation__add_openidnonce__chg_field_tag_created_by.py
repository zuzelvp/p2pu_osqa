...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forum_tag', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forum.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tag.created_by'
        db.alter_column('forum_tag', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['forum.User']))
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 2, 14, 10, 50, 356860)'}),
        ...
        'forum.tag': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_tags'", 'null': 'True', 'to': "orm['forum.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 3, 14, 14, 15, 314412)'}),
